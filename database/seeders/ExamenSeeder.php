...
//   array('parametros' => '[{"parametro": "Coloración de gram", "resultado": {"tipo": "datalist", "nombre": "gram_a", "items": ["cocos Gram positivos aislados escasos", "negativo para diplococos gram Negativos intra y extra celulares"]}}, {"parametro": "reacción leucocitaria", "resultado": {"tipo": "lista", "nombre": "r_leuc", "items": ["escasa", "moderada", "aumentada"]}}]','nombre_examen' => 'Frotis de secreción uretral ','nombre_alternativo' => 'COLORACIÓN DE GRAM','descripcion' => 'análisis de sangre que mide la cantidad de glóbulos blancos en el cuerpo. Los glóbulos blancos, también llamados leucocitos','CUP' => '901107','valor' => '16000.00'),
//   array('parametros' => '[{"grupo": "examen fisico-quimico", "parametros": [{"parametro": "color", "resultado": {"tipo": "lista", "nombre": "color", "items": ["hidrico", "amarillo", "ambar", "amarillo intenso", "rojo"]}}, {"parametro": "aspecto", "resultado": {"tipo": "lista", "nombre": "aspecto", "items": ["lig turbio", "turbio", "limpido"]}}, {"parametro": "densidad", "resultado": {"tipo": "number", "nombre": "densidad"}, "unidades": "g/dL"}, {"parametro": "pH", "resultado": {"tipo": "number", "nombre": "ph"}}, {"parametro": "glucosa", "resultado": {"tipo": "text", "default": "negativo", "nombre": "glucosa"}, "unidades": "mg/dL"}, {"parametro": "cetonas", "resultado": {"tipo": "text", "default": "negativo", "nombre": "cetonas"}, "unidades": "mg/dL"}, {"parametro": "leucocito esterasa", "resultado": {"tipo": "lista", "items": ["positivo", "negativo"], "nombre": "leucocito"}}, {"parametro": "proteinas", "resultado": {"tipo": "text", "default": "negativo", "nombre": "proteinas"}, "unidades": "mg/dL"}, {"parametro": "pigmentos biliares", "resultado": {"tipo": "text", "default": "negativo", "nombre": "pigmentos"}, "unidades": "mg/dL"}, {"parametro": "hemoglobina", "resultado": {"tipo": "text", "default": "negativo", "nombre": "hemoglobina"}}, {"parametro": "nitritos", "resultado": {"tipo": "lista", "items": ["positivo", "negativo"], "nombre": "nitritos"}}, {"parametro": "urobilinogeno", "resultado": {"tipo": "text", "default": "normal", "nombre": "urobilinogeno"}, "unidades": "mg/dL"}]}, {"grupo": "examen microscopico", "parametros": [{"parametro": "cel epiteliales", "resultado": {"tipo": "range", "nombre": "epiteliales"}, "unidades": "x campo"}, {"parametro": "leucocitos", "resultado": {"tipo": "range", "nombre": "leucocitos"}, "unidades": "x campo"}, {"parametro": "hematies", "resultado": {"tipo": "range", "nombre": "hematies"}, "unidades": "x campo"}, {"parametro": "bacterias", "resultado": {"tipo": "range", "nombre": "bacterias"}}, {"parametro": "moco", "resultado": {"tipo": "range", "nombre": "moco"}}]}, {"parametro": "observaciones", "resultado": {"tipo": "textarea", "nombre": "observacion", "items": ["muestra contaminda, se solicita nueva muestra"]}}]','nombre_examen' => 'uroanalisis','nombre_alternativo' => 'parcial de orina','descripcion' => '','CUP' => '907106','valor' => '16000.00'),
...
//   array('parametros' => '[{"parametro": "Ácido úrico", "resultado": {"nombre": "acido_urico", "tipo": "number"}, "unidades": "mg/dL", "referencia": {"adultos": {"salida": "2.5 - 7.0", "minimo": 2.5, "maximo": 7.0}, "mujeres": {"salida": "1.5 - 6.0", "minimo": 1.5, "maximo": 6.0}}}]','nombre_examen' => 'Ácido Úrico','nombre_alternativo' => NULL,'descripcion' => 'mide la cantidad de ácido úrico en una muestra de sangre u orina','CUP' => '903801','valor' => '16000.00'),
  ...
  array('parametros' => '[{"parametro": "KoH piel  y uñas", "resultado": {"tipo": "lista", "nombre": "koh", "items": ["negativo", "positivo"]}}, {"parametro": "observaciones", "resultado": {"tipo": "textarea", "nombre": "observaciones", "default": "No se observan estructuras micoticas"}}]','nombre_examen' => 'Koh Piel y Uñas','nombre_alternativo' => 'hidróxido de potasio','descripcion' => 'examen cutáneo simple que se utiliza para identificar infecciones fúngicas en las uñas, la piel y el cabello. La prueba consiste en tratar muestras de una zona infectada con KOH, que disuelve las células de la piel y deja las células del hongo visibles bajo un microscopio','CUP' => '906002','valor' => '12000.00'),
  ...
  array('parametros' => '[{"parametro": "Coloración de gram", "resultado": {"tipo": "datalist", "nombre": "gram_a", "items": ["cocos Gram positivos aislados escasos", "negativo para diplococos gram Negativos intra y extra celulares"]}}, {"parametro": "reacción leucocitaria", "resultado": {"tipo": "lista", "nombre": "r_leuc", "items": ["escasa", "moderada", "aumentada"]}}]','nombre_examen' => 'Frotis de secreción','nombre_alternativo' => 'COLORACIÓN DE GRAM','descripcion' => 'usado para ayudar a identificar bacterias. Se puede tomar una muestra para evaluación de los fluidos corporales que normalmente no contienen bacterias, tales como sangre, orina o líquido cefalorraquídeo','CUP' => '901107','valor' => '16000.00'),
  ...
  array('parametros' => '[{"parametro": "hematocrito", "resultado": {"tipo": "number", "nombre": "hto"}, "unidades": "%", "referencia": {"adultos": {"salida": "42-52", "minimo": 42, "maximo": 52}, "menores": {"salida": "35-44", "minimo": 35, "maximo": 44}}}, {"parametro": "hemoglobina", "resultado": {"tipo": "number", "nombre": "hb"}, "unidades": "g%", "referencia": {"adultos": {"salida": "13.5-16.5", "minimo": 13.5, "maximo": 16.5}, "menores": {"salida": "11.0-13.5", "minimo": 11, "maximo": 13.5}}}, {"parametro": "recuento de leucocitos", "resultado": {"tipo": "number", "nombre": "leu"}, "unidades": "leu/mm³", "referencia": {"adultos": {"salida": "5000-10000", "minimo": 5000, "maximo": 10000}, "menores": {"salida": "7000-13000", "minimo": 7000, "maximo": 13000}}}, {"parametro": "neutrofilos", "resultado": {"tipo": "number", "nombre": "neutrofilos"}, "unidades": "%", "referencia": {"adultos": {"salida": "52-67", "minimo": 52, "maximo": 67}, "menores": {"salida": "35-60", "minimo": 35, "maximo": 60}}, "grupo": "recuento diferencial"}, {"parametro": "linfocitos", "resultado": {"tipo": "number", "nombre": "linfocitos"}, "unidades": "%", "referencia": {"adultos": {"salida": "27-42", "minimo": 27, "maximo": 42}, "menores": {"salida": "25-50", "minimo": 25, "maximo": 50}}, "grupo": "recuento diferencial"}, {"parametro": "eosinofilos", "resultado": {"tipo": "number", "nombre": "eosinofilos"}, "unidades": "%", "referencia": {"adultos": {"salida": "0-3", "maximo": 3}}, "grupo": "recuento diferencial"}, {"parametro": "monocitos", "resultado": {"tipo": "number", "nombre": "monocitos"}, "unidades": "%", "referencia": {"adultos": {"salida": "3-7", "minimo": 3, "maximo": 7}}, "grupo": "recuento diferencial"}, {"parametro": "celulas inmaduras", "resultado": {"tipo": "number", "nombre": "inmaduras"}, "unidades": "%", "grupo": "recuento diferencial"}, {"parametro": "recuento de plaquetas", "resultado": {"tipo": "number", "nombre": "rto_plaquetas"}, "unidades": "plaq/mm³", "referencia": {"adultos": {"salida": "150000-450000", "minimo": 150000, "maximo": 450000}}}, {"parametro": "vsg", "resultado": {"tipo": "number", "nombre": "vsg"}, "unidades": "mm/h", "referencia": {"adultos": {"salida": "0-22", "minimo": 0, "maximo": 22}}}]','nombre_examen' => 'Cuadro Hematico','nombre_alternativo' => 'Cuadro hematico - Sin observacion','descripcion' => 'Conjunto de pruebas de laboratorio médico realizadas a la sangre del paciente con el fin de obtener información sobre el número, composición y proporciones de los elementos figurados de la sangre. ','CUP' => '902207','valor' => '16000.00'),
  array('parametros' => '[{"parametro": "Antigeno específico de próstata", "subtitulo": "Prueba rápida semicuantitativa para (PSA) \\n Negativo menor a 3 ng/ml", "resultado": {"tipo": "lista", "nombre": "psa", "items": ["positivo", "negativo"]}}, {"parametro": "observaciones", "resultado": {"tipo": "textarea", "nombre": "observacion", "items": ["Se sugiere realizar prueba cuantitativa"]}}]','nombre_examen' => 'ANTIGENO ESPECÍFICO DE PRÓSTATA (PSA)','nombre_alternativo' => 'PSA','descripcion' => 'Prueba rápida para detectar semicuantitativamente niveles de Antigeno Prostatico Especifico(PSA) en sangre suero o plasma','CUP' => '906610','valor' => '26000.00')
);
