<section>
                <div class="grid grid-cols-4 bg-cyan-400 mb-2 gap-1 font-semibold text-yellow-50">
                    ...
                    <div class="text-center">v referencia</div>
                                        ...
                                        <div class="p-2">
                                                                                            <input step="0.001" type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" name="poli_de" id="poli_de">
                                                                                    </div>
                                                                                    <div class="p-2">
                                                %
                                            </div>
                                        ...
                                        <div class="p-2">
                                                                                            <input step="0.001" type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" name="poli_iz" id="poli_iz">
                                                                                    </div>
                                                                                    <div class="p-2">
                                                %
                                            </div>
                                        ...
                                        <div class="p-2 ml-1 uppercase"> Fosa nasal derecha</div>
                                        <div class="p-2">
                                                                                            <input step="0.001" type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" name="mono_de" id="mono_de">
                                                                                    </div>
                                                                                    <div class="p-2">
                                                %
                                            </div>
                                        ...
                                        <div class="p-2 ml-1 uppercase"> Fosa nasal izquierda</div>
                                        <div class="p-2">
                                                                                            <input step="0.001" type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" name="mono_iz" id="mono_iz">
                                                                                    </div>
                                                                                    <div class="p-2">
                                                %
                                            </div>
                                        ...
                                        <div class="p-2 ml-1 uppercase"> Fosa nasal derecha</div>
                                        <div class="p-2">
                                                                                            <input step="0.001" type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" name="eos_de" id="eos_de">
                                                                                    </div>
                                                                                    <div class="p-2">
                                                %
                                            </div>
                                        ...
                                        <div class="p-2 ml-1 uppercase"> Fosa nasal izquierda</div>
                                        <div class="p-2">
                                                                                            <input step="0.001" type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" name="eos_iz" id="eos_iz">
                                                                                    </div>
                                                                                    <div class="p-2">
                                                %
                                            </div>
