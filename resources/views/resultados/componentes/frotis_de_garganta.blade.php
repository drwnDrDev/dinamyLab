<section>
                <div class="grid grid-cols-4 bg-cyan-400 mb-2 gap-1 font-semibold text-yellow-50">
                    ...
                    <div class="text-center">v referencia</div>
                            ...
                            <div class="p-2 font-semibold uppercase"> Coloracíon de Gram</div>
                                                            <div class="p-2">
                                    <input type="text" name="f_bacteriana" id="f_bacteriana" value="Flora bacteriana mixta normal de orofaringe">
                                </div>
                            ...
                            <div class="p-2 font-semibold uppercase"> reacción leucocitaria</div>
                                                            <div class="p-2">
                                    <input type="text" name="r_leucocitaria" id="r_leucocitaria">
                                </div>
