<section>
    ...
    <div class="grid grid-cols-4 text-lg gap-1">
        <div class="p-2 font-semibold uppercase">Resultado</div>
        <div class="p-2">
            <select name="resultado" class="rounded-lg uppercase" id="resultado">
    ...
    <div class="grid grid-cols-4 text-lg gap-1">
        <div class="p-2 font-semibold uppercase">FUR</div>
        <div class="p-2">
