<section>
    ...
    <div class="grid grid-cols-4 text-lg gap-1">
        <div class="p-2 font-semibold uppercase"> KoH piel y uñas</div>
        <div class="p-2">
            <select name="koh" class="rounded-lg uppercase" id="koh">
    ...
    <div class="grid grid-cols-4 text-lg gap-1">
        ...
        <div class="p-2">
            <input type="text" name="observaciones" id="observaciones" value="No se observan estructuras micoticas">
        </div>
