<section>
    ...
    <div class="grid grid-cols-4 text-lg gap-1">
        ...
        <div class="p-2">
            <input type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" step="0.001" name="glicemia-pre"
                id="glicemia-pre">
        </div>
    ...
    <div class="grid grid-cols-4 text-lg gap-1">
        ...
        <div class="p-2">
            <input type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" step="0.001" name="glicemia-post"
                id="glicemia-post">
        </div>
