<section>
                <div class="grid grid-cols-4 bg-cyan-400 mb-2 gap-1 font-semibold text-yellow-50">
                    ...
                    <div class="text-center">v referencia</div>
                            ...
                            <div class="p-2 font-semibold uppercase"> glicemia basal</div>
                                                            <div class="p-2">
                                    <input type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" step="0.001" name="glicemia-pre" id="glicemia-pre">
                                </div>
                                ...
                                mg/dL
                                                            ...
                                                            <div class="grid grid-cols-4 text-lg gap-1">
                            <div class="p-2 font-semibold uppercase"> glicemia post-prandial</div>
                                                            <div class="p-2">
                                    <input type="number" class="w-24 h-8 bordrder border-spacing-0 rounded" step="0.001" name="glicemia-post" id="glicemia-post">
                                </div>
