<nav x-data="{ open: false }" 
    :class="{'mt-16 w-60 row-span-1 h-screen border-r border-borders transition-[width] duration-300 ease-in-out du print:hidden': open, 'mt-16 w-14 row-span-1 h-screen border-r border-borders transition-[width] duration-300 ease-in-out': ! open }">
    <!-- Hamburger -->
