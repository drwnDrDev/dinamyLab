<x-app-layout>
    ...
    <x-canva class="print:bg-white print:shadow-none print:rounded-none">
        ...
        <div class="py-4 flex justify-between items-center">
            <div>
                ...
                <p class="text-titles">
                 <span id="tipo-documento">info</span>
                 <span id="numero-documento">info</span>
                </p>
            </div>
        ...
        <div id="ticket" ordenId="{{$orden->id}}" class="print:hidden"></div>
    </x-canva>
