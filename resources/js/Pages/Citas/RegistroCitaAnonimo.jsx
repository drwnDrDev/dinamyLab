...
export default function RegistroCitaAnonimo({ sedes, modalidades }) {
                    ...
                    <div className="border-b pb-6">
                        ...
                        <div className="mb-4">
                            ...
                            {errors.nombres_completos && (
                                <p className="mt-1 text-sm text-red-600">{errors.nombres_completos}</p>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                {errors.fecha_deseada && (
                                    <p className="mt-1 text-sm text-red-600">{errors.fecha_deseada}</p>
                                )}
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                />
                                {errors.hora_deseada && (
                                    <p className="mt-1 text-sm text-red-600">{errors.hora_deseada}</p>
                                )}
                            </div>
                        </div>
